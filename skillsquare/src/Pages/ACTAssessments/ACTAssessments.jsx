...
function WelcomeScreen({onStart}){
  const [form,setForm]=useState({name:"",college:"",studies:"",department:""});
    ...
    <div className="act-welcome">
      ...
      <div className="act-hero act-wrap">
        ...
        <div className="act-reg">
          ...
          <div className={`act-field${errors.name?" err":""}`}>
            <label>Full name</label>
            <input type="text" placeholder="e.g. Priya Ramesh" value={form.name}
    ...
    <div className="toptokker">
      ...
      <div className="act-examhead">
        <div className="act-wrap">
          ...
          <div className="act-who"><b>{student.name}</b> · <span>{student.department} · {student.studies}</span></div>
...
function ResultScreen({quiz,answers,student,timeLeft,onRetake}){
  ...
  const handleDownload=()=>{
    const lines=["ACT ASSESSMENT — SKILL SQUARE","Learn. Grow. Get Hired.","=".repeat(42),
      "Candidate : "+student.name,"College   : "+student.college,
    ...
    a.download="ACT_Result_"+student.name.replace(/\s+/g,"_")+".txt";
        ...
        <div className="act-wrap">
          ...
          <div className="act-resinfo">
            ...
            <div className="act-resmeta">
              {[["Candidate",student.name],["College",student.college],["Studies",student.studies],
